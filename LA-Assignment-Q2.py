...
def main():
    ...
    square_vertices_rotated = rotate(square_vertices_scaled, 45)  # Rotate by 45 degrees
    square_vertices_translated = translate(square_vertices_rotated, 2, 1)  # Translate by (2, 1)
    plot_shape(square_vertices_translated, 'blue', 'Body of the House')

    # Roof of the house (triangle)
    triangle_vertices = [[2, 2], [3, 4], [4, 2]]
    triangle_vertices_scaled = scale(triangle_vertices, 1.5)  # Scaling by 1.5
    triangle_vertices_rotated = rotate(triangle_vertices_scaled, 45)  # Rotate by 45 degrees
    triangle_vertices_translated = translate(triangle_vertices_rotated, 2, 1)  # Translate by (2, 1)
    ...
    rectangle_vertices_scaled = scale(rectangle_vertices, 1.5)  # Scaling by 1.5
    rectangle_vertices_rotated = rotate(rectangle_vertices_scaled, 45)  # Rotate by 45 degrees
    rectangle_vertices_translated = translate(rectangle_vertices_rotated, 2, 1)  # Translate by (2, 1)
